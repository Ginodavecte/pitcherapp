            ...
            <div class="row cart-body">
                <form class="w-100 p-3" method="post" action="">
                  <div class="row d-flex align-items-start">
                    ...
                    <!--COMMENT-->
                    <div class="card mt-5" style="border-color: #999;">
                      <div class="card-header" style="color: #eee; background-image: linear-gradient(to bottom, #555 0px, #888 100%);"></div>
                  <div class="form-group">
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#creditcard">Comment</a>
                          </li>
                        </ul>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card" style="border-color: #999;">
                            <div class="card-header" style="color: #eee; background-image: linear-gradient(to bottom, #555 0px, #888 100%);">
                                  Review Order <div class="float-right"><small><a class="afix-1" href="#" style="color: #eee";>Edit Cart</a></small></div>
                              </div>
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col">
